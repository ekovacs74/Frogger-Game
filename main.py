...
FroggerX, FroggerY, FroggerWidth, FroggerHeight = 250, 250, 64, 64 # Properties of Frogger
        ...
        for event in pygame.event.get():
              ...
              if event.type == pygame.QUIT:  # Quit Event
                  ...
                  if event.key == pygame.K_UP and FroggerY > 0: # Button for moving up with limits
                      ...
                      FroggerY += 64
                  elif event.key == pygame.K_RIGHT and FroggerX < ScreenWidth - FroggerWidth * 2: # Button for moving right with limits
                      FroggerX += 64
